...
@Component({
  selector: 'app-meeting-manage-topic',
  templateUrl: './meeting-manage-topic.component.html',
  styleUrls: ['./meeting-manage-topic.component.css']
})
export class MeetingManageTopicComponent {
  ...
  ngOnInit(): void {
    ...
    this.meeting_code = this.route.snapshot.paramMap.get('id'); // รหัสนักศึกษา/epassport
    this.meeting_name = this.route.snapshot.paramMap.get('name'); // รหัสนักศึกษา/epassport
  }
